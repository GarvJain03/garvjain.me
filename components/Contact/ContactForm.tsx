  ...
  return (
    ...
    >
      ...
      <div className="-m-2 flex flex-wrap">
        ...
        <button className="mx-2 mt-4 flex w-full items-center justify-center space-x-2 rounded-lg border border-soft-red px-8 py-3 text-white transition duration-200 ease-in-out hover:bg-soft-red active:outline-soft-red">
